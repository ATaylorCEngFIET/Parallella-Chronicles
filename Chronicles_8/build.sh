...
# Build DEVICE side program
#e-gcc -T ${ELDF} Src/Epiphany_Hello2.c -o Debug/e_hello_world2.elf -le-lib

# Convert ebinary to SREC file
#e-objcopy --srec-forceS3 --output-target srec Debug/e_hello_world2.elf Debug/hello_world2.srec
